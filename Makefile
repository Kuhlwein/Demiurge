...
SOURCES += $(wildcard src/*.cpp) $(wildcard src/projections/*.cpp)  $(wildcard src/menus/*.cpp) $(wildcard src/geometry/*.cpp) $(wildcard src/appearance/*.cpp) $(wildcard src/filter/*.cpp) $(wildcard $(IMGUI)/*.cpp)
